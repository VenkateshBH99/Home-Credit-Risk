...
\begin{enumerate}
    ...
    \item \textbf{Deliver stakeholder value:} Provide banking partners with smarter investment decisions and improved \ac{LTV}:\ac{CAC} ratios; help credit bureau companies generate more fee-based recurring revenue through better scores; and give regulators privacy-by-default, consent-based, auditable model predictions.
...
\ProjectFigure*[H][width=0.95\textwidth]{pptx/model architecture.png}{Model Architecture}{Overall model architecture showing the flow from raw data sources through feature engineering, model training, and evaluation.}{fig:model_architecture}
...
\fcolorbox{black}{white}{\adjustimage{max totalsize={0.87\linewidth}{0.162\textheight},center}{pptx/stakeholders-banking and financial partners.png}}%
\endgroup
\captionof{figure}[Banking Stakeholders]{Banking \& Financial Partners -- key concerns include profitability, customer trust, and data privacy.}
\label{fig:stakeholders_banking}
\end{minipage}\hfill%
\begin{minipage}[t]{0.315\textwidth}
\centering
\adjustimage{max totalsize={0.87\linewidth}{0.162\textheight},center}{pptx/stakeholders - credit bureau companies.png}
\captionof{figure}[Bureau Stakeholders]{Credit Bureau Companies -- key concerns include \ac{ROI}, integration complexity, and strategic fit.}
\label{fig:stakeholders_bureau}
\end{minipage}\hfill%
\begin{minipage}[t]{0.315\textwidth}
\centering
\adjustimage{max totalsize={0.87\linewidth}{0.162\textheight},center}{pptx/stakeholders - regulators.png}
\captionof{figure}[Regulatory Stakeholders]{Regulators \& Governments -- key concerns include risk exposure, data governance, and model fairness.}
\label{fig:stakeholders_regulators}
\end{minipage}
\end{center}
