...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{pptx/model architecture.png}
    \caption{Overall model architecture showing the flow from raw data sources through feature engineering, model training, and evaluation.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{pptx/stakeholders-banking and financial partners.png}
    \caption{Banking \& Financial Partners -- key concerns include profitability, customer trust, and data privacy.}
    \label{fig:stakeholders_banking}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{pptx/stakeholders - credit bureau companies.png}
    \caption{Credit Bureau Companies -- key concerns include ROI, integration complexity, and strategic fit.}
    \label{fig:stakeholders_bureau}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{pptx/stakeholders - regulators.png}
    \caption{Regulators \& Governments -- key concerns include risk exposure, data governance, and model fairness.}
